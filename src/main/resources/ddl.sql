...
create table grupo_permissao (grupo_id bigint not null, permissoes_id bigint not null) engine=InnoDB
...
alter table grupo_permissao add constraint FKlw4o9abl31ryji6uwkflmefp8 foreign key (permissoes_id) references permissao (id)
